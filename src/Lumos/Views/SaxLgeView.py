...
class SAX_LGE_View(View):
    def __init__(self):
        ...
        import Lumos.Guis.Addable_Tabs.CC_LGE_Metrics_Histos_Tab        as tab5
        import Lumos.Guis.Addable_Tabs.CCs_CRs_OverviewTable_Tab        as tab6
        import Lumos.Guis.Addable_Tabs.CCs_Metrics_OverviewTable_Tab    as tab7

        import Lumos.Guis.Addable_Tabs.MULTI_ClinicalResults_Tab        as tab8
        import Lumos.Guis.Addable_Tabs.MULTI_Histos_Tab                 as tab9
