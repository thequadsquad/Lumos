...
class CC_AngleAvgT1ValuesTable(Table):
    def calculate(self, case_comparison, category, nr_segments, byreader=None):
        ...
        Args:
            case_comparison (Lumos.Containers.Case_Comparison): two cases after View.customize_case(case)
            category (Lumos.Category): a mapping category for slice and contour access
