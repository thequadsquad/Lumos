...
class SAX_T1_PRE_View(View):
    def __init__(self):
        ...
        self.clinical_parameters = [cr() for cr in [SAXMap_GLOBALT1_PRE, NR_SLICES]]
        ...
        import RoomOfRequirement.Guis.Addable_Tabs.CC_Angle_Segments_Tab        as tab3
        import RoomOfRequirement.Guis.Addable_Tabs.CC_Overview_Tab              as tab4
        import RoomOfRequirement.Guis.Addable_Tabs.CC_AHA_Tab                   as tab5
        import RoomOfRequirement.Guis.Addable_Tabs.CC_AHA_Diff_Tab              as tab6
        import RoomOfRequirement.Guis.Addable_Tabs.CCs_AHA_Tab                  as tab7
        import RoomOfRequirement.Guis.Addable_Tabs.CCs_AHA_Diff_Tab             as tab8
        import RoomOfRequirement.Guis.Addable_Tabs.CCs_Mapping_Slice_Analysis   as tab9
